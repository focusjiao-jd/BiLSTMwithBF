...
def get_nli(data_path):
    ...
    for data_type in ['train', 'dev', 'test']:
        ...
        # s1[data_type]['adjpath'] = os.path.join(data_path, 'adj1.' + data_type)
        # s2[data_type]['adjpath'] = os.path.join(data_path, 'adj2.' + data_type)
        ...
        # s1[data_type]['adj'] =  [json.loads(line.rstrip('\n')) for line in
        #                          open(s1[data_type]['adjpath'], 'r')]
        # s2[data_type]['adj'] =  [json.loads(line.rstrip('\n')) for line in
        #                          open(s2[data_type]['adjpath'], 'r')]
